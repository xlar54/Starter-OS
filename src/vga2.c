...
#include "ports.h" /* FP_SEG(), FP_OFF(), inportb(), outportb() */

#define pokeb(addr, offset, val) (void)(*((unsigned char*)(long)(addr)) = (val))
#define peekb(addr, offset) (*((unsigned char*)(long)(addr + offset)))
#define pokew(addr, offset, val) (void)(*((unsigned short*)(long)(addr + offset)) = (val))
...
{
	long addr = get_fb_seg();
	addr += off;
	
	*((unsigned char*)(addr)) = val;
	
	//(void)(*((unsigned char*)(long)(addr)) = (val))
...
{
	puts("Screen-clear in 16-color mode will be VERY SLOW\n"
